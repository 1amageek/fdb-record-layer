...
public protocol Recordable: Sendable, Codable {
    ...
    /// Directory path components declared with #Directory macro
    ///
    /// This property should be automatically generated by @Recordable macro
    /// to represent the directory structure for this record type.
    ///
    /// **Path components can be**:
    /// - Literal strings: `Path("tenants")`
    /// - Field references: `Field(\.tenantID)`
    ///
    /// **Example (generated by macro)**:
    /// ```swift
    ...
    /// ```
    ///
    /// If the type doesn't use #Directory macro, it returns an empty array.
    static var directoryPathComponents: [any DirectoryPathElement] { get }

    /// Directory layer type declared with #Directory macro
    ///
    /// This property should be automatically generated by @Recordable macro
    /// to specify the directory layer type (partition, recordStore, etc.).
    ///
    /// **Example (generated by macro)**:
    /// ```swift
    /// #Directory<User>(..., layer: .partition)
    ///
    /// // Macro generates:
    /// static var directoryLayerType: DirectoryLayerType {
    ///     return .partition
    /// }
    /// ```
    ///
    /// If the type doesn't use #Directory macro, it returns `.recordStore` (default).
    static var directoryLayerType: DirectoryLayerType { get }
}
...
extension Recordable {
    ...
    /// Default implementation of directory path components
    ///
    /// Returns empty array for types without #Directory macro.
    /// @Recordable macro will override this for types with #Directory.
    public static var directoryPathComponents: [any DirectoryPathElement] {
        return []
    }

    /// Default implementation of directory layer type
    ///
    /// Returns .recordStore for types without #Directory macro.
    /// @Recordable macro will override this for types with #Directory.
